...
const Edit: FC = () => {
  ...
  function setPassword(e: React.FocusEvent<HTMLInputElement>): void {
    setEntry("currentPassword", e.target.value.trim());
  }
  function setNewPassword(e: React.FocusEvent<HTMLInputElement>): void {
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                ...
                <TextField
                  ...
                  value={getDate(data.birthDate) || getDate(user.birthDate) || ""}
                />
              </Grid>
              <Grid item xs={6}>
                <TextField
